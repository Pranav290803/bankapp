...
<input type="submit" value="Modify User Details" formmethod="post" formaction="ModifyDashboard.jsp">
<input type="submit" value="See User Details" formmethod="post" formaction="UserDetails.jsp">
<input type="submit" value="Back" formmethod="post" formaction="Admin.jsp">
</form>
</body>
</html>
